...
public class Login extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // If the database connection information is valid, dispatch to the login page
        if (infoBDValide(getServletContext())) {
            DispatchToLogin(request, response);
        } else {
            // If not, dispatch to the database connection page
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                // Si les informations de connexion sont valides, créer une nouvelle connexion
